    ...
    return (
        <div className="flex flex-row justify-between h-14 bottom-4 border-b-2 border-gray-900 bg-backcolor">
            <div className="flex flex-row items-center">
                <img src="/LOGO.png" alt="logo" className="h-10 w-10 ml-4 rounded-full hover:cursor-pointer" onClick={() => navigate.push('/')}/>
                <a className="items-center text-center font-sans font-bold rounded-lg focus:ring-blue-200 flex flex-col justify-center h-14 text-3xl p-0 ml-[10px] mr-10 shrink-0 bg-gradient-to-r from-red-300 to-red-700 bg-clip-text text-transparent" href="/">Exelios</a>
                <a className="items-center text-center font-semibold rounded-lg focus:ring-blue-200 flex flex-col justify-center bg-transparent h-14 text-md p-0 font-sans hover:text-gray-300 " href="/">Markets</a>
                <a className="items-center text-center ml-8 font-semibold rounded-lg focus:ring-blue-200 flex flex-col justify-center bg-transparent h-14 text-md p-0 font-sans " href="/trade/SOL_USDC">Spot</a>
            </div>
            ...
            <div className="flex flex-row">
                ...
                <div className="ml-6 flex flex-row align-middle">
                    <a className="items-center text-center font-semibold rounded-lg focus:ring-blue-200 text-gray-400 flex flex-col justify-center bg-transparent h-14 text-sm p-0 my-auto mr-6" href="/">
